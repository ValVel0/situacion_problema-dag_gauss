...
Se evaluó la probabilidad de que un individuo presente niveles elevados de creatinina sérica (>1.2 mg/dL, indicativo de posible daño renal), condicionado a un valor específico de hemoglobina glicosilada (HbA1c = 6.5%) y una concentración específica de material particulado fino (PM₂.₅ = 12 μg/m³).
