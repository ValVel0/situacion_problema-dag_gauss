...
```{r}
dag_salud1 = empty.graph(nodes = c("sexo", "edad", "entidad", 
...
graphviz.plot(dag_salud1, shape = "ellipse")
```

```{r}
# guardamos la imagen
png("figures/diagrama_dag_salud1.png", width = 1200, height = 800, res = 150)
graphviz.plot(dag_salud1, shape = "ellipse")
dev.off()
```
...
dag_salud2 = empty.graph(nodes = c("sexo", "edad", "entidad", 
                                 "valor_PCR", "valor_COLEST", "valor_COL_LDL", "valor_COL_HDL", 
                                 "valor_TRIG", "valor_GLU_SUERO", "valor_HBAC", "hb02", "valor_CREAT",
                                 "SO2", "CO", "NOx", "PM_010", "PM_2_5", "COV", "NH3"))
...
```{r}
dev.new(width=12, height=8)  
graphviz.plot(dag_salud2, shape = "ellipse")
```

```{r}
# guardamos la imagen
png("figures/diagrama_dag_salud2.png", width = 1200, height = 800, res = 150)
graphviz.plot(dag_salud2, shape = "ellipse")
dev.off()
```
