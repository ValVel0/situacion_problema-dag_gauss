...
```{r}
# Cargar la red bayesiana ajustada (si no está ya cargada)

# Definir los umbrales:
# - Creatinina alta: valor_CREAT > 1.2 mg/dL (umbral común para adultos)
# - HbA1c elevado: valor_HBAC >= 6.5% (indicador de diabetes o mal control)
# - Alto PM₂.₅: PM_2_5 > 12 μg/m³ (basado en estándares de calidad del aire)

# Realizar la consulta de probabilidad condicional
cpquery(
    fit_dag2,
    event = (valor_CREAT > 1.2),
    evidence = list(valor_HB1AC = 6.5, PM_2_5 = 12),
    method = "lw"
)
