...
```{r}
strenght_dag1 = arc.strength(dag_1, data = df_final, method = 'mi')
strenght_dag1 
```

```{r}
strenght_dag2 = arc.strength(dag_2, data = df_final, method = 'mi')
strenght_dag2 
```

```{r}
strenght_dag3 = arc.strength(dag_3, data = df_final, method = 'mi')
strenght_dag3 
```
